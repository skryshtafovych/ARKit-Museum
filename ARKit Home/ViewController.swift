...
//  ARKit Home
//
//  Created by Stepan Kryshtafovych on 7/17/18.
//  Copyright © 2018 Stepan Kryshtafovych. All rights reserved.
//
...
//
    ...
    func resetTracking() {
        ...
        guard let referenceImages = ARReferenceImage.referenceImages(inGroupNamed: "AR Tickets", bundle: nil) else {
...
//
    func updateTotalCard(temp_test :String){
        let formattedTotal = "Hello Stepan 3"
